...
![PopToBins](/assets/img/RecBin_PopToBin.png) {% include image.html
    src="/assets/img/RecBin_PopToBin.png" <!-- image filename (placed in /assets/images) -->
    alt="PopToBins" <!-- alt text -->
    caption="This is Jekyll's logo, featuring Dr. Jekyll's serum!" <!-- Caption -->
%}

![PopToBins](/assets/img/RecBin_PopToBin.png) ![TypeDistribution](/assets/img/RecBin_TypeDis.png)
